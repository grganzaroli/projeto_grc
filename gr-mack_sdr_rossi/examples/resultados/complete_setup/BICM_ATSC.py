...
class BICM_ATSC_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.r = r = 10
        self.n = n = 64800
        self.EsN0_dB = EsN0_dB = [4, 5, 6, 7, 8, 9, 10, 11, 12]
        ...
        for EsNo in self.EsN0_dB:
            ...
            self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/media/rossi/02C46D54C46D4ACD/Users/grgan/Desktop/RESULTADOS_COMPLETO/PN_bicm_completo_'+str(EsNo)+'.bin', False)
