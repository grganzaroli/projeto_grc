...
# Title: Bch Decoder2
# Generated: Sat Oct 27 13:28:16 2018
##################################################
...
class BCH_Decoder2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.r = r = 10
        self.n = n = 64800
        self.EsN0_dB = EsN0_dB = 0

        ##################################################
        # Blocks
        ##################################################
        self._EsN0_dB_range = Range(-50, 50, 1, 0, 200)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'bch_decoder.bin', False)
