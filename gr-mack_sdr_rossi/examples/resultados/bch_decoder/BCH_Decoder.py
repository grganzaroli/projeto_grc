...
# Title: Bch Decoder2
# Generated: Sat Oct 27 12:30:36 2018
##################################################
...
class BCH_Decoder2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Bch Decoder2")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Bch Decoder2")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "BCH_Decoder2")
        ...
        self.r = r = 10
        self.n = n = 64800
        self.EsN0_dB = EsN0_dB = [10, 10.2, 10.4, 10.6, 10.8, 11, 11.2, 11.4, 11.6, 11.8, 12]
        ...
        for EsNo in EsN0_dB:
            ...
            self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'bch_decoder_' + str(EsNo) + '.bin', False)
            ...
            self.connect((self.bch_enc_0, 0), (self.mapper_atsc_0, 0))    
...
def main(top_block_cls=BCH_Decoder2, options=None):
