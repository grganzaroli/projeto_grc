...
public:
	...
	void parity_inter(const float *lambda, float *U); // APENAS LDPC TIPO B
	...
	void block_inter_tipo_A(const float *BI_in, float *BI_out, int rows_p1, int rows_p2, int col);
	...
	void block_inter_tipo_B(const float *BI_in, float *BI_out, int n_p1, int n_p2, int nqcb);
